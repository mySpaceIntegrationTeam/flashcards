class CardsController < ApplicationController
  ...
  private
    ...
    def card_params
      params.require(:card).permit(:id, :title, :side_a_text, :side_b_text, :side_a_math, :side_b_math, :side_a_image, :side_b_image, :card_back_color, :card_text_color, :deck_id, :is_hidden)
    end
end
